...
const ScholarshipRequestItem = (item) => {
    const imageUrl =
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.post(
                    `/api/studentsection/updateLCRequest/${item.mis}`,
                    data
                );
        ...
        <li class="py-3 sm:py-4 hover:bg-gray-100 p-3 hover:rounded-xl">
            <div class="flex items-center">
                ...
                <div class="flex-1 min-w-0 ms-4">
                    ...
                    ) : <div class="w-24 p-2 mb-1 mt-1 text-sm text-green-800 rounded-full bg-green-50 " role="alert">
...
export default ScholarshipRequestItem