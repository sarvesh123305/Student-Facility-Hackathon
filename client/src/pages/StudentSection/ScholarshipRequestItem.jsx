...
import { updateScholarshipItem } from '../../redux/actions/studentSection';
const ScholarshipRequestItem = ({
...
export default connect(mapStateToProps, { updateScholarshipItem })(
    ScholarshipRequestItem
);
