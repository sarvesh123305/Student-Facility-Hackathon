...
const FeeReceiptRequests = ({
  studentsection: { feeReceiptRequests },
  initialLoadUser,
  getFeeReceiptRequests,
}) => {
  useEffect(() => {
  ...
  const [data, setData] = useState(feeReceiptRequests);
