...
const StudentSectionNotifications = () => {
  const imageUrl =
  ...
  //         'http://localhost:5000/api/student/notifications/142203012'
  //       );
    ...
    <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
      <div class="flex items-center justify-between mb-4">
        ...
        <div
          ...
          role="alert"
        >
          <span class="font-medium">4 Notifications</span>
        </div>
      </div>
      <div class="flow-root">
        <ul role="list" class="divide-y divide-gray-200">
            ...
            <div class="flex items-center">
              ...
              <div class="flex-1 min-w-0 ms-4">
                <p class="text-md font-medium text-gray-900 truncate">
                  Scholarship [142203012]
                </p>
                <p class="text-md text-gray-500 truncate">
                  I have not received Scholarship from 2 months
                </p>
              </div>
          ...
          <li class="py-3 sm:py-4 hover:bg-gray-100 p-3 hover:rounded-xl">
            <div class="flex items-center">
              ...
              <div class="flex-1 min-w-0 ms-4">
                <p class="text-md font-medium text-gray-900 truncate">
                  Scholarship[112103144]
                </p>
                <p class="text-md text-gray-500 truncate">
                  My scholarship form is getting rejected apart from being
                  filled it correctly
                </p>
              </div>
              <div class="inline-flex items-center text-base font-semibold text-gray-900">
          ...
          <li class="py-3 sm:py-4 hover:bg-gray-100 p-3 hover:rounded-xl">
            <div class="flex items-center">
              ...
              <div class="flex-1 min-w-0 ms-4">
                <p class="text-md font-medium text-gray-900 truncate">
                  Scholarship [142203002]
                </p>
                <p class="text-md text-gray-500 truncate">
                  On My scholarship page , it shows not eligible , but I'm
                </p>
              </div>
              <div class="inline-flex items-center text-base font-semibold text-gray-900">
                Apr 6
...
export default StudentSectionNotifications;
