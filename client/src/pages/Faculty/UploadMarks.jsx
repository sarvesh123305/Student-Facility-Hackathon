...
const UploadMarks = () => {
    ...
    return marksData.map((rowData, index) => (
      ...
      >
        <td class="px-6 py-4">
          <input
            type="text"
            class="bg-white-50 border border-black-300 text-black-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-black-600 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
            id={rowData.misLabel}
            value={rowData.MIS}
            disabled
            required
  ...
  return (
    <div>
      ...
      <input
        class="block w-full text-sm text-black-900 border border-black-300 rounded-lg cursor-pointer bg-white-50 dark:text-black-400 focus:outline-none dark:bg-white-700 dark:border-black-600"
        aria-describedby="file_input_help"
        id="csvFileInput"
        type="file"
      />
      <p
        class="mt-1 text-sm text-black-500 dark:text-black-300"
        id="file_input_help"
      >
