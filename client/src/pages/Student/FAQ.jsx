      ...
      <div id="accordion-collapse" data-accordion="collapse">
          ...
          >
            <div className="text-gray-500 dark:text-gray-400">
              ...
              <p className="mb-2">
                ...
                administrative team. Once the team approves, you will be able to
                download the Bonafide Certificate.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            <div className="text-gray-500 dark:text-gray-400">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                ...
                undergo verification and approval by the scholarship committee.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            <div className="text-gray-500 dark:text-gray-400">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                ...
                details and upload the SBI Collect Fee Receipt. The Fee Receipt
                will be verified by the account section and then the system will
                generate the digitally verified fee receipt for you to download
                or print.
              </p>
            </div>
          </div>
        ...
        <div className="mt-4 shadow-md">
          <h2 id="accordion-collapse-heading-4">
            ...
            >
              <span>
                How long does it take for my requested documents to be available
                after approval?
              </span>
              <svg
                data-accordion-icon
          ...
          >
            <div className="text-gray-500 dark:text-gray-400">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                ...
                the type of document and the administrative workload. Typically,
                approved documents are made available within 1-3 business days.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 shadow-md">
          ...
          >
            <div className="text-gray-500 dark:text-gray-400">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                Yes, you can view your CGPA (Cumulative Grade Point Average) on
                the student portal. Navigate to the "Academic Profile" section
                to find your CGPA for each semester as well as your overall
                CGPA.
              </p>
            </div>
          </div>
          ...
          >
            <div className="text-gray-500 dark:text-gray-400">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                ...
                details and address, through the "Update Profile" section of the
                student portal. Make sure to review and save the changes after
          ...
          >
            <div className="text-gray-500 dark:text-gray-400">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                ...
                account, access the course registration section, and follow the
                prompts to select your courses for the upcoming semester.
              </p>
            </div>
          </div>
        </div>
        <div className="mt-4 shadow-md">
          ...
          >
            <div className="text-gray-500 dark:text-gray-400">
              <p className="mb-2 text-gray-500 dark:text-gray-400">
                In most cases, course registration changes are not allowed once
                the registration period has ended. However, if there are
                exceptional circumstances, you can contact the academic services
