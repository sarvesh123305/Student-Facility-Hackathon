  ...
  return (
    <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
      <div class="flex items-center justify-between mb-4">
        ...
        <div
          class="p-4 text-sm text-blue-800 rounded-full bg-blue-50"
          role="alert"
        >
          <span class="font-medium">20 Notifications</span>
        </div>
      </div>
      <div class="flow-root">
            ...
            <div class="flex items-center">
              ...
              <div class="flex-1 min-w-0 ms-4">
                ...
                <p class="text-sm text-gray-500 truncate">
                  Kindly inform to all students about Submission of Scholarship/
                  Free ship Application Form AY 2022-23 along with all documents
                  xerox copies uploaded during filling applications online on
                  Maha DBT.
                </p>
              </div>
