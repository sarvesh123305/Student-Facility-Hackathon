...
const SearchDropdown = ({ results }) => {
    return (
        <div id="dropdownDivider" class="z-10  absolute bg-gray-200 top-14 md:left-1/2 lg:left-1/2 transform -translate-x-1/2 bg-white divide-y divide-gray-100 rounded-lg shadow w-1/3 ">
