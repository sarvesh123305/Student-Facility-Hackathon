            ...
            <div className="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 sm:mx-auto sm:w-full sm:max-w-sm md:max-w-md ">
              <ul className="flex items-stretch mx-auto w-full sm:max-w-sm text-lg font-medium text-center text-gray-500  ">
                <li className="me-2">
                  <Link
                    to="/login"
                    className={`inline-block px-4 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 ${role === "Student" ? "text-white bg-blue-600 " : ""
                      }`}
                    aria-current="page"
                  >
                    Student Login
                ...
                <li className="me-2">
                  <Link
                    to="/Faculty/login"
                    className={`inline-block px-4 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 ${role === "Faculty" ? "text-white bg-blue-600" : ""
                      } `}
                  >
                    Faculty Login
                  </Link>
                ...
                <li className="me-2">
                  <Link
                    ...
                    className={`inline-block px-4 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 ${role === "StudentsSection" ? "text-white bg-blue-600" : ""
                      }`}
                  >
